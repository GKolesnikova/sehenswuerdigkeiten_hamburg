                ...
                <div className="modal-dialog modal-xl modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel" style={{ color: " #00bbde"}}>Update sight </h1>
                        ...
                        <div className="modal-footer">
                            <button type="submit" className="btn btn-outline-info update" data-bs-dismiss="modal" style={{width: "11em", height: "2.5em"}}
                                    onClick={handleSubmit}  >Update
                            </button>
                            <button type="button" className="btn btn-outline-warning delete" data-bs-dismiss="modal" style={{width: "7em", height: "2.5em"}}
                                     >Close
                            </button>
                        </div>
                    </div>
